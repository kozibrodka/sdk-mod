...
public class SdkRenderBulletRocketLaser extends EntityRenderer {

    public SdkRenderBulletRocketLaser()
    {
    }

    public void renderArrow(SdkEntityBullet sdkentitybullet, double d, double d1, double d2,
                            float f, float f1)
    {
        bindTexture("/assets/sdk/stationapi/textures/item/itemRocketsLaser.png");
        GL11.glPushMatrix();
