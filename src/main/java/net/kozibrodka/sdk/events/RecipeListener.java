...
public class RecipeListener {
    ...
    public void addGunRecipes(RecipeRegisterEvent event){
        CraftingRegistry.addShapedRecipe(new ItemStack(Item.IRON_INGOT, 1), "XX", "XX", Character.valueOf('X'), ItemCasingListener.itemBulletCasing);
        CraftingRegistry.addShapedRecipe(new ItemStack(Item.IRON_INGOT, 1), "XX", "XX", Character.valueOf('X'), ItemCasingListener.itemBulletCasingShell);
