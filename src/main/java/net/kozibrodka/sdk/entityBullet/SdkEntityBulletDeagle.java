...
public class SdkEntityBulletDeagle extends SdkEntityBullet implements EntitySpawnDataProvider
{

    public SdkEntityBulletDeagle(World world)
    {
        super(world);
    }
    ...
    {
        world.playSound(this, ((SdkItemGun)ItemListener.itemGunDeagle).firingSound, ((SdkItemGun) ItemListener.itemGunDeagle).soundRangeFactor, 1.0F / (random.nextFloat() * 0.1F + 0.95F));
    }

    @Override
    public Identifier getHandlerIdentifier() {
        return Identifier.of(EntityListener.MOD_ID, "BulletDeagle");
    }
}
